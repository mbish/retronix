      ...
      mkIf cfg.enable (mkMerge [
        (subtypes.commonEmulationConfig cfg)
        {
          xdg.configFile = mkMerge [
            {
              "dolphin-emu/GCPadNew.ini".source = cfg.gc-pad-ini;
              "dolphin-emu/WiimoteNew.ini".source = cfg.wiimote-ini;
              "dolphin-emu/Dolphin.ini".source = dolphinConfig;
              "dolphin-emu/GBA.ini".source = cfg.gba-ini;
            }
          ];
          home.file = let
